  ...
  return (
    <section className="divider py-10 bg-[var(--surface-1)]">
      ...
      <div
        ...
        style={{ maskImage: "linear-gradient(to right, transparent 0%, black 8%, black 88%, transparent 100%)", WebkitMaskImage: "linear-gradient(to right, transparent 0%, black 8%, black 88%, transparent 100%)" }}
      >
