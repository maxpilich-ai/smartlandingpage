...
export const testimonials = [
  ...
  { name: "Mike R.", location: "Plymouth, MN", rating: 5, source: "Google", text: "Hurricane Ian took out half our Florida property. Smart Construction flew a crew down within a week. Full restoration, insurance paid everything. Incredible team." },
  { name: "Sarah T.", location: "Maple Grove, MN", rating: 5, source: "Google", text: "They found $23,000 in damage my insurance adjuster completely missed. Drone inspection caught everything. Would never have known without them." },
  { name: "James C.", location: "Woodbury, MN", rating: 5, source: "Facebook", text: "Three bids, Smart Construction was not the cheapest. Chose them anyway for the warranty and the claim help. Best decision I made. Roof looks incredible." },
  { name: "Karen M.", location: "Punta Gorda, FL", rating: 5, source: "Google", text: "After the storm we didn't know where to start. Smart Construction handled the adjuster meeting, the paperwork, everything. We just had to show up for the final walkthrough." },
  { name: "Tom W.", location: "Lakeville, MN", rating: 5, source: "BBB", text: "State Farm's first offer was insulting. Pavel's team documented every shingle and got us triple the original settlement. Worth every minute of the process." },
  { name: "Linda F.", location: "Sarasota, FL", rating: 5, source: "Google", text: "GAF shingles, lifetime warranty, zero out of pocket. Insurance covered it all. The crew was fast, clean, and professional. Already recommended to four neighbors." },
